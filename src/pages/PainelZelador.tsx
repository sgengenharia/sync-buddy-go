...
export default function PainelZelador() {
  ...
  useEffect(() => {
    document.title = 'Painel do Zelador | Dashboard';
  }, []);
    ...
    switch (selectedPage) {
      case 'dashboard':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Dashboard do Zelador</CardTitle>
              <CardDescription>Resumo das tarefas e ocorrências</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex h-14 items-center justify-between px-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Painel do Zelador</span>
            </div>
